...
public:
    ...
    */
    ...
    void drawTerrain(const Transform& model, const Transform& view, const Transform& projection,
                     const bool use_texture, const GLuint texture,std::vector<Point> lightSources, std::vector<Vector> lightDir);

    void drawPlayer(const Transform& model, const Transform& view, const Transform& projection,
                     const bool use_texture, const GLuint texture, std::vector<Point> lightSources, std::vector<Vector> lightDir);

    void drawObstacle(const Transform &model, const Transform &view, const Transform &projection,
...
protected:    
    ...
    GLuint create_programTerrain( const bool use_texcoord= true, const bool use_normal= true, const bool use_color= true, const bool use_light= false, const bool use_alpha_test= false );
    GLuint create_programPlayer( const bool use_texcoord= true, const bool use_normal= true, const bool use_color= true, const bool use_light= false, const bool use_alpha_test= false );
    GLuint create_programObstacle( const bool use_texcoord= true, const bool use_normal= true, const bool use_color= true, const bool use_light= false, const bool use_alpha_test= false );
